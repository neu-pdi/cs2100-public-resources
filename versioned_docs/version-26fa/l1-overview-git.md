...
In this course, the assignment autograders will check and assign points to proper style (according to Pylint) and variable type hints (according to MyPy).
